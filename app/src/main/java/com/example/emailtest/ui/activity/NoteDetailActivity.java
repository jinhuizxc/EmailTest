...
import com.example.emailtest.utils.IOUtil;
...
public class NoteDetailActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_jishiben_detail);
			...
			public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
				new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String path = new IOUtil().stream2file(is, Environment.getExternalStorageDirectory().toString() +
                        		"/XingYe/" + attachmentsList.get(position));
                        if (path == null) {
	...
	class MyMailToAdatper extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			convertView = View.inflate(NoteDetailActivity.this, R.layout.item_mail_to_address, null);
	...
	class GetMailDetailTask extends AsyncTask<String, Void, HashMap<String, Object>>{
		...
		protected void onPreExecute() {
			super.onPreExecute();
			dialog=new ProgressDialog(NoteDetailActivity.this);
	...
	private static class MyHandler extends Handler {
	    ...
	    private WeakReference<NoteDetailActivity> wrActivity;
	
	    public MyHandler(NoteDetailActivity activity) {
	        this.wrActivity = new WeakReference<NoteDetailActivity>(activity);
	    }
	
	    @Override
	    public void handleMessage(android.os.Message msg) {
	        final NoteDetailActivity activity = wrActivity.get();
	        switch (msg.what) {
	            case 0:
...
public void onClick(View v) {
	...
	case R.id.image_xingbiao:
		new PopupWindows(NoteDetailActivity.this,image_xingbiao);
	break;
	case R.id.image_huifu:
		Intent intent = new Intent(NoteDetailActivity.this,NoteXiuGaiActivity.class);
		intent.putExtra("NoteId", getIntent().getStringExtra("NoteId"));
		startActivity(intent);
	break;
	case R.id.image_delet:
		note.deleteNote(getIntent().getStringExtra("NoteId"));
		finish();
	break;
	case R.id.image_more:
		new PopupWindows3(NoteDetailActivity.this,image_xingbiao);
	break;
	}
	...
	public class PopupWindows extends PopupWindow {
		...
		public PopupWindows(Context mContext, View parent) {
			...
			tv_yidu.setVisibility(View.GONE);
...
//					mailService.updateTypeById(getIntent().getStringExtra("id"), "6");
			...
			tv_xingbiao.setOnClickListener(new OnClickListener() {
				@Override
				public void onClick(View v) {
					note.update(getIntent().getStringExtra("NoteId"), "1");
					Toast.makeText(NoteDetailActivity.this, "添加成功", Toast.LENGTH_SHORT).show();
					dismiss();
				}
			});
		}
...
//				public void onClick(View v) {
//					
//					Intent intent = new Intent(NoteDetailActivity.this, WriteEmailActivity.class);
...
//				}
//			});
//			tv_zhuanfa.setOnClickListener(new View.OnClickListener() {
//				@Override
//				public void onClick(View v) {
//					
...
//	}
	...
	public class PopupWindows3 extends PopupWindow {
		...
		public PopupWindows3(Context mContext, View parent) {
			View view = View.inflate(mContext, R.layout.select_jishiben_more, null);
			view.startAnimation(AnimationUtils.loadAnimation(mContext,R.anim.fade_ins));
			LinearLayout ll_1 = (LinearLayout) view.findViewById(R.id.ll_1);
			ll_1.startAnimation(AnimationUtils.loadAnimation(mContext,R.anim.push_bottom_in_2));
			...
			TextView tv_zhuanfa = (TextView) view.findViewById(R.id.tv_zhuanfa);
			TextView tv_yidong = (TextView) view.findViewById(R.id.tv_yidong);
			tv_rili.setOnClickListener(new OnClickListener() {
				@Override
				public void onClick(View v) {
					Intent intent = new Intent(NoteDetailActivity.this, BuildActivity.class);
					intent.putExtra("id", getIntent().getStringExtra("id"));
					startActivity(intent);
					dismiss();
				}
			...
			tv_zhuanfa.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					if(user.getUsername()!=null && getIntent().getStringExtra("mailfrom")!=null){
						intent.putExtra("user", user);
						intent.putExtra("zhuanfa", "zhuanfa");
						intent.putExtra("id", getIntent().getStringExtra("id"));
						String str = getIntent().getStringExtra("mailfrom");
			...
			tv_yidong.setOnClickListener(new OnClickListener() {
				@Override
				public void onClick(View v) {
					Intent intent = new Intent(NoteDetailActivity.this, MoveJiShiActivity.class);
					intent.putExtra("id", getIntent().getStringExtra("NoteId"));
					startActivity(intent);
					dismiss();
				}
			});
