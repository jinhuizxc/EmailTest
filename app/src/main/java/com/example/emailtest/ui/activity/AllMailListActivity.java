...
public class AllMailListActivity extends Activity implements  OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mailListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				SPUtils.putValue(AllMailListActivity.this, user.getUsername(),
	...
	public void onClick(View v) {
		...
		case R.id.image_edit:{
			Intent intent = new Intent(AllMailListActivity.this, WriteEmailActivity.class);
			startActivity(intent);
		}
			break;
		default:
	...
	public class MailAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			// 做的本地假已读未读
			boolean isBoolean = SPUtils.getValue(context,userService.findByUserId(mb.getUserId()).getUsername(), mb.getSubject()+mb.getSendTime(), false);
