 ...
 * 邮箱登录页面
 */
public class EmailLoginActivity extends Activity implements OnClickListener {
    ...
    private void initViews() {
        ...
        image_xiayibu.setOnClickListener(this);
    ...
    private void loginEmail() {
        ...
        if (!userService.hasUser(account)) {
            new LoginTask().execute(account, pwd);
        } else {
    ...
    class LoginTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if ("0".equals(result)) {
                ...
                Toast.makeText(EmailLoginActivity.this, "请您先开通授权码，确保输入正确。", Toast.LENGTH_SHORT).show();
            } else if ("2".equals(result)) {
                Toast.makeText(EmailLoginActivity.this, "未知异常，请联系客服。", Toast.LENGTH_SHORT).show();
            }
