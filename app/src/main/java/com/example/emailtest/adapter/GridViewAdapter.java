...
//            convertView = getLayout(holder);
            convertView = LayoutInflater.from(mActivity).inflate(R.layout.item_link, parent,false);
    ...
    private LinearLayout getLayout(Holder holder) {
        ...
        LinearLayout.LayoutParams params1 = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.MATCH_PARENT, (int) (60 * 1.5));
        ...
        linearLayout.addView(textView2, params1);
