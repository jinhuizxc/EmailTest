...
//	private static String week[] = {"周日","周一","周二","周三","周四","周五","周六"};
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		////////////////////////////////------////////
		ClanderService clanderService = new	ClanderService(context);
		List<HashMap<String, Object>> list = clanderService.findClanderAll();
		ImageView image_1 = (ImageView) convertView.findViewById(R.id.image_1);
		String str = getShowYear()+getShowMonth()+d;
		...
		for(int i=0;i<list.size();i++){
			...
			if(time>=startime && time<=endtime){
				...
				image_1.setBackgroundDrawable(res.getDrawable(R.drawable.sw));
			}else{
...
//		}
		...
		if(currentFlag == position){ 
			//设置当天的背景
			textView.setBackgroundColor(Color.parseColor("#138cdf"));
