...
import com.example.emailtest.mail.util.HtmlFormatUtil;
...
public class MailListActivity extends Activity implements XListView.IXListViewListener, OnClickListener {
...
//				intent.putExtra("position", String.valueOf(position-1));
                ...
                SharedPreferencesUtils.putValue(MailListActivity.this, user.getUsername(),
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.image_edit: {
                Intent intent = new Intent(MailListActivity.this, WriteActivity.class);
                intent.putExtra("user", user);
                startActivity(intent);
            }
            break;
